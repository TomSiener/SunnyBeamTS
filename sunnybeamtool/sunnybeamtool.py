...
_LOGGER = Logger.with_default_handlers(level=logging.INFO)
...
class SunnyBeam:
    ...
    async def _connect(self) -> None:
        ...
        self._dev = dev
        _LOGGER.info("Connected to %s from %s with serial number %s" % (self._dev.product,self._dev.manufacturer,self._dev.serial_number,))
